    ...
    /*private void tambahMarker() {
        ...
        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            private View infoWindow(Marker marker) {
                LinearLayout infoView = new LinearLayout(AlamatPengantaran.this);
                ...
                TextView nama = new TextView(AlamatPengantaran.this);
                nama.setText("Lokasi Anda");
                TextView go = new TextView(AlamatPengantaran.this);
                go.setText("PILIH!");
                go.setTextColor(Color.RED);
                infoView.addView(nama);
                infoView.addView(go);

                arrayMarker.add(mMarker);
    ...
    */
    ...
    public void onLocationChanged(Location location) {
        ...
        try {
            ...
            TextView t = (TextView) findViewById(R.id.alamat);
            t.setText(address+", "+city+", "+state+" "+postalCode+", "+country);
            sm.saveAlamat(address+", "+city+", "+state+" "+postalCode+", "+country);
        } catch (IOException e) {
            e.printStackTrace();
        } catch (Exception e) {
            e.printStackTrace();
